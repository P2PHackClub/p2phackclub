...
- The [GitHub projects](https://github.com/p2phackclub/)
- The [Discord](https://discord/#)
- Club Meetings
...
If you encounter a conduct-related issue, you should report it to the coleads (contact@p2phack.club), or to [Peak to Peak directly through the communication pathways.](https://www.peaktopeak.org/Page/1129).
...
Changes to the Code of Conduct should be proposed by creating an issue [here](https://github.com/hackclub/hackclub/issues/new) or making a pull request to this document.
...
- If you encounter an issue, please mail contact@p2phack.club or [Peak to Peak directly through the communication pathways.](https://www.peaktopeak.org/Page/1129)

## Acknowledgments

This Code of Conduct has been adapted from the [national Hack Club Code of Conduct](https://hackclub.com/conduct/) which adapted from [Go's Code of Conduct](https://github.com/golang/go/commit/aa487e66f869785837275ee20441a53888a51bb2). It is to be noted that many parts of Go's Code of Conduct are adopted from the Code of Conduct documents of the Django, FreeBSD, and Rust projects.
